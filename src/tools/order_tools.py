...
def create_order_tools(assistant):
    ...
    async def place_order(
        ...
        await send_sms(assistant.dialed_number, assistant.caller_phone, customer_sms)
        
        # Send SMS to merchant (WITH pickup time)
        if assistant.notification_phone:
            ...
            await send_sms(assistant.dialed_number, assistant.notification_phone, merchant_sms)
        else:
